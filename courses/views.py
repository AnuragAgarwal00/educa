...
class OwnerCouseMixin(OwnerMixin, LoginRequiredMixin, PermissionRequiredMixin):
    model = Course
    fields = ['subject', 'title', 'slug', 'over_view']
    success_url = reverse_lazy('manage_course_list')


class OwnerCourseEditMixin(OwnerCouseMixin, OwnerEditMixin):
    template_name = 'courses/manage/course/form.html'


class ManageCourseListView(OwnerCouseMixin, ListView):
...
class CourseDeleteView(OwnerCouseMixin, DeleteView):
...
class CourseModuleUpdateView(TemplateResponseMixin, View):
    ...
    def dispatch(self, request, pk):
        self.course = get_object_or_404(Course, pk=pk, owner=self.request.user)
